...
layout: use-case
title: 物联网案例
description: ThingsBoard IoT平台案例
notitle: "true"
...
ThingsBoard IoT平台功能强大、可扩展且用户友好，它通过提供灵活且强大的开箱即用功能来支持各种物联网案例，从而缩短您的互联产品和智能解决方案的上市时间。该平台与设备无关，因此您可以从任何传感器、连接设备或应用程序中馈送和分析遥测数据。ThingsBoard 全面的功能和丰富的平台 API 允许您节省常规物联网任务的时间和资源，并专注于物联网解决方案的特定功能。
