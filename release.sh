...
do
  ...
  find . -type f -iname "$ext" -exec sed -i -e '/https/! s/\/images\//https:\/\/img.docs.codingas.com\//g' {} \;
  find . -type f -iname "$ext" -exec sed -i -e 's/https:\/\/docs.codingas.com\/images\//https:\/\/img.docs.codingas.com\//g' {} \;
  find . -type f -iname "$ext" -exec sed -i -e '/https:\/\/img.docs.codingas.com\/partners\/map-of-distributors\.svg/ s/https:\/\/img.docs.codingas.com\/partners\/map-of-distributors\.svg/\/images\/partners\/map-of-distributors.svg/g' {} \;
done
