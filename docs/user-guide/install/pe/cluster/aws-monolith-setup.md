...
rdsSetup:
    ...
    3:
        ...
        title: '确保你的 PostgreSQL RDS 实例可从 ThingsBoard 集群访问；实现此目的的最简单方法是在同一个 VPC 中部署 PostgreSQL RDS 实例，并使用“eksctl-thingsboard-cluster-ClusterSharedNodeSecurityGroup-*”安全组。'
    4:
