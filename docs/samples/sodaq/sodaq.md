...
We will use free ThingsBoard PE demo server [thingsboard.cloud](https://cloud.codingas.com/signup) in this guide.
...
Otherwise, you can register for a 30-days free demo account here: [thingsboard.cloud](https://cloud.codingas.com/signup).
