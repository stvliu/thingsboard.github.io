...
In this guide, we will use the free ThingsBoard PE demo server [thingsboard.cloud](https://gridlinks.codingas.com/signup) in this guide.
...
Otherwise, you can register for a 30-days free demo account here: [thingsboard.cloud](https://gridlinks.codingas.com/signup).
