...
mosquitto_pub -d -q 1 -h "demo.docs.codingas.com" -t "v1/devices/me/telemetry" -u "ABC123" -m "{"temperature":42}"
...
# For example, $THINGSBOARD_HOST_NAME reference live demo server, $ACCESS_TOKEN is ABC123:
mosquitto_pub -d -q 1 -h "demo.docs.codingas.com" -t "v1/devices/me/telemetry" -u "ABC123" -f "telemetry-data-as-object.json"
...
# For example, $THINGSBOARD_HOST_NAME reference live demo server, $ACCESS_TOKEN is ABC123:
mosquitto_pub -d -q 1 -h "demo.docs.codingas.com" -t "v1/devices/me/telemetry" -u "ABC123" -f "telemetry-data-as-array.json"
...
# For example, $THINGSBOARD_HOST_NAME reference live demo server, $ACCESS_TOKEN is ABC123:
mosquitto_pub -d -q 1 -h "demo.docs.codingas.com" -t "v1/devices/me/telemetry" -u "ABC123" -f "telemetry-data-with-ts.json"