...
cat telemetry-data-as-object.json | coap post coap://demo.docs.codingas.com/api/v1/ABC123/telemetry
...
# For example, $THINGSBOARD_HOST_NAME reference live demo server, $ACCESS_TOKEN is ABC123:
cat telemetry-data-as-array.json | coap post coap://demo.docs.codingas.com/api/v1/ABC123/telemetry
...
# For example, $THINGSBOARD_HOST_NAME reference live demo server, $ACCESS_TOKEN is ABC123:
cat telemetry-data-with-ts.json | coap post coap://demo.docs.codingas.com/api/v1/ABC123/telemetry