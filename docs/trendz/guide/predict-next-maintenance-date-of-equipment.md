...
装配机已通过 OPC-UA 集成连接到 GridLinks，并且遥测数据可在 GridLinks 中使用。您可以在我们的 [连接指南](https://docs.codingas.com/docs/pe/guides/#AnchorIDConnectYourDevice) 中找到有关如何执行此操作的更多详细信息。
