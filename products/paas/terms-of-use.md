---
layout: plain
title: ThingsBoard Cloud 使用条款
description: ThingsBoard Cloud 使用条款
...
<br>
<p>这些服务条款，包括其特定于国家/地区的附录（<b>“TBCP 服务协议”</b>、<b>“TBCP 协议”</b>、<b>“协议”</b>）代表了对 ThingsBoard Cloud 平台的访问和使用所适用的条款和条件，目前可以通过 URL：<a href="https://thingsboard.cloud">https://thingsboard.cloud</a> 默认或可能不时使用的其他配置的自定义域访问。本文件是接受这些条款的实体或个人（<b>“客户”</b>或<b>“您”</b>）与 ThingsBoard 实体（下称<b>“我们”</b>、<b>“我们的”</b>或<b>“ThingsBoard Cloud 平台”</b>）之间适用的具有法律约束力的协议，该实体列于下文第 2 段。通过使用 ThingsBoard Cloud 平台，客户确认并同意他们已阅读、理解并同意受条款的约束，并且您接触的所有附属用户或用户（<b>“最终用户”</b>）均受本服务条款的约束。</p>

<p> <b>1. 提交和接受条款</b> </p> 
<p> 1.1 客户对 ThingsBoard Cloud 平台的使用受本文件所含条款和条件以及 ThingsBoard Cloud 平台隐私政策、Stripe 服务条款以及不时采用并与 ThingsBoard Cloud 平台集成的任何其他网站或服务政策或条件（统称为<b>“条款”</b>）的约束。</p>

<p>1.2 本 TBCP 服务协议在客户首次访问 ThingsBoard Cloud 平台时生效（<b>“生效日期”</b>）。如果您代表客户接受条款或访问平台，则您声明并保证 (i) 您拥有将客户约束至本 TBCP 服务协议的完全法律授权；(ii) 您已阅读并理解本 TBCP 服务协议；以及 (iii) 您代表客户同意本 TBCP 服务协议。反之亦然，客户被视为承担责任，声明并保证所有用户接受并遵守这些条款。    

<b>如果您不同意并接受所有条款，请不要使用本服务。您确认并同意 ThingsBoard 可以随时通过在 ThingsBoard Cloud 平台上发布相关修订和重述的条款来修改任何条款。除非 ThingsBoard 另行明确宣布，否则对条款的任何更改在发布后立即生效。通过继续使用服务，您同意受最新发布的条款的约束。</b>
</p>
...
<br>
<p> <b>2. 服务提供</b> </p> 
<p> 2.1 您签订合同的 ThingsBoard 法律实体是 ThingsBoard, Inc.（称为<b>“ThingsBoard”</b>）</p>

<p>2.2 您必须在 ThingsBoard Cloud 平台上注册为客户才能访问和使用服务。</p>

<p>2.3 ThingsBoard 有权因违反条款或附加协议而限制、暂停或终止您对 ThingsBoard Cloud 平台或服务中的任何功能的访问或使用。</p>
...
<br>
<p> <b>3. ThingsBoard Cloud 平台的使用</b> </p> 
...
<br>&nbsp;&nbsp;&nbsp;&nbsp;(e) 在不限制上述一般性的情况下，复制、复制、下载、编译或以其他方式使用服务，以经营与 ThingsBoard Cloud 竞争的业务； 
...
<br>&nbsp;&nbsp;&nbsp;&nbsp;(d) 做出任何行为，根据 ThingsBoard, Inc. 的唯一意见或 ThingsBoard Cloud 的保护机制，可能破坏服务和客户的安全；
...
<br>
<p> <b>4. 服务的撤销和暂停</b> </p> 
<p> 4.1 ThingsBoard, Inc. 有权自行决定删除、修改或拒绝您提交、发布或显示在 ThingsBoard Cloud 平台上的任何内容，如果我们认为该内容是非法的、违反条款的或可能使 ThingsBoard, Inc. 承担责任，而无需任何退款索赔。</p>
...
<p>5.4 您特此同意赔偿并使 ThingsBoard Cloud、其各自的关联公司、董事、高级职员和员工免受任何和所有损失、索赔、责任的损害，这些损失、索赔、责任可能因您使用服务或您违反任何条款而产生。您特此进一步同意赔偿并使 ThingsBoard, Inc.、其关联公司、董事、高级职员和员工免受任何和所有损失、损害、索赔、责任（包括全额赔偿基础上的法律费用）的损害，这些损失、损害、索赔、责任可能直接或间接地产生，作为任何第三方索赔人或其他第三方因您使用 ThingsBoard Cloud 平台而提出的索赔或潜在索赔的结果。您特此进一步同意，ThingsBoard, Inc. 不对您负责，也不对您承担任何责任，对于其他人发布或提交的任何材料，包括诽谤性、攻击性或非法材料，并且此类材料造成的损害风险完全由您承担。</p>
...
<p>6.6 除非另与客户达成协议，否则所有适用的服务费应在 ThingsBoard 发票上（或其他方式）支付，无需提供采购订单号。</p>
</p> 
<br>
<p> <b>7. 不可抗力</b></p>
...
<br>
<p> <b>9. 知识产权</b> </p> 
<p>9.1 ThingsBoard, Inc. 是 ThingsBoard Cloud Platform 中所有权利和权益的唯一所有者。ThingsBoard Cloud Platform 中的所有所有权和知识产权应归 ThingsBoard, Inc.、其关联公司或 ThingsBoard Cloud 内容的许可方（视情况而定）。</p> 
...
<p>10.3 ThingsBoard Cloud Platform 政策允许终止向您提供服务，如果您没有为此类服务支付相应的服务费。</p>
