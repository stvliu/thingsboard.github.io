...
将以下行添加到 yml 文件。不要忘记用你的 **实际 Pub/Sub 项目 ID 和服务帐户（它是 json 文件中的全部数据）替换“YOUR_PROJECT_ID”、“YOUR_SERVICE_ACCOUNT”，并用你在第一步中获得的 **许可证密钥替换“PUT_YOUR_LICENSE_SECRET_HERE”：
