...
将以下行添加到 yml 文件。不要忘记用你的 **真实 AWS SQS IAM 用户凭证** 替换 "YOUR_KEY"、"YOUR_SECRET"，用你的 **真实 AWS SQS 账户区域** 替换 "YOUR_REGION"，用你在第一步中获得的 **许可证密钥** 替换 "PUT_YOUR_LICENSE_SECRET_HERE"：
