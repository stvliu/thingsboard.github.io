...
将以下行添加到 yml 文件。不要忘记将“YOUR_NAMESPACE_NAME”替换为您的 **实际服务总线命名空间名称**，并将“YOUR_SAS_KEY_NAME”、“YOUR_SAS_KEY”替换为您的 **实际服务总线凭据。注意：“YOUR_SAS_KEY_NAME”是“SAS 策略”，“YOUR_SAS_KEY”是“SAS 策略主密钥”：**
...
services:
  mytb:
    ...
    environment:
      ...
      # 
      # 根据案例，如果消息负载较低，您可以权衡延迟并减少队列的分区/请求数。
