...
## GridLinks CE vs PE security features comparison

#### GridLinks Community Edition

![image](/images/user-guide/security/rbac/TB_CE.png)

GridLinks Community Edition supports a straight-forward security model with three main roles: *System administrator*, *Tenant administrator*, and *Customer user*. 
...
GridLinks Community Edition functionality is sufficient for a lot of simple use cases, especially building real-time [end-user dashboards](/docs/{{docsPrefix}}user-guide/dashboards/).
...
GridLinks supports the "recursive" customer hierarchy with tens of thousands of sub-customers.
...
Users are able to login to the GridLinks web interface, execute REST API calls, access devices, and assets if it's allowed. The User is also an Entity in GridLinks.
...
An Entity can be a device, asset, user, dashboard, entity view, etc. Any entity is managed by GridLinks. See [entities and relations](/docs/{{docsPrefix}}user-guide/entities-and-relations/) guide for more details.
...
Anything that has the secure APIs or represents a GridLinks Entity is a resource. 
...
GridLinks use special “connection” called Group Permission Entity (GPE) which grants permissions of Generic Role for User Group.
...
| API Usage State               | "All", "Read", "Read Telemetry"                                                                                                                                                                                                                                                                    | API Usage layout is in the main menu of the GridLinks platform. API Usage shows full statistics on the platform. Learn more about API Usage [here](/docs/{{docsPrefix}}user-guide/ui/aliases/#api-usage-state).                                                                                                                                                                                                                                                                                                                                          |
...
| Edge                          | "All", "Change Owner", "Create", "Delete", "Read", "Read Attributes", "Read Telemetry", "Write", "Write Attributes", "Write Telemetry"                                                                                                                                                             | GridLinks Edge is an extension of the GridLinks platform designed for local data processing and device management in a distributed IoT environment. GridLinks Edge supports offline operation when there is no access to the cloud-based GridLinks server. Find out more information about a device [here](/docs/{{docsPrefix}}edge/getting-started-guides/what-is-edge/).                                                                                                                                                                         |
...
| Integration                   | "All", "Change Owner", "Create", "Delete", "Read", "Read Attributes", "Read Telemetry", "Write", "Write Attributes", "Write Telemetry"                                                                                                                                                             | Integration is the process of connecting and interacting GridLinks with other systems or devices to exchange and manage data. To know more about the entity groups check the article [here](/docs/user-guide/integrations/).                                                                                                                                                                                                                                                                                                                             |
...
| Profile                       | “All”, “Read”, “Write”, “Create”, “Delete”                                                                                                                                                                                                                                                         | With these permissions, the user can edit their profile information and change the login password for their GridLinks instance.                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| Role                          | “All”, “Change Owner”, “Create”, “Delete”, “Read”, “Read Attributes”, “Read Telemetry”, “Write”, “Write Attributes”, “Write Telemetry”                                                                                                                                                             | Roles in GridLinks define a set of permissions and access rights assigned to users to perform specific actions in the system. Roles allow limiting or granting access to functionality and data based on the user’s role.                                                                                                                                                                                                                                                                                                                                |
| Rule Chain                    | “All”, “Change Owner”, “Create”, “Delete”, “Read”, “Read Attributes”, “Read Telemetry”, “Write”, “Write Attributes”, “Write Telemetry”                                                                                                                                                             | Rule Chain in GridLinks is a sequence of rules and actions applied to data received from devices or other sources. Rule Chains automate data processing, enable decision-making based on specific conditions, and perform actions such as notifications, device state changes, and other operations. Rule Chains can be configured to process and route data for various purposes, simplifying the development and deployment of IoT logic in the GridLinks system. Learn more about rule chain [here](/docs/{{docsPrefix}}user-guide/ui/rule-chains/). |
...
| Version Control               | “All”, “Delete”, “Read”, “Write”                                                                                                                                                                                                                                                                   | GridLinks Version Control service provides the ability to export and restore GridLinks Entities using Git. Learn more about Version Control [here](/docs/{{docsPrefix}}user-guide/version-control/).                                                                                                                                                                                                                                                                                                                                                   |
...
To summarize those requirements in GridLinks terms, we should implement the following roles:
...
Let's configure GridLinks to support this use case. The instructions below assume that you have logged in as a Tenant Administrator.
...
5. Click on the "+" sign at the top right of the screen. Input email address, for instance, we can use _janesmith@docs.codingas.com_, and click "Add";
...
3. Input email address, for example, we will use _bob@docs.codingas.com_, then click "Add";
