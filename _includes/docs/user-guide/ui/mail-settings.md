...
首先，您必须以 *系统管理员* 身份登录到您的 GridLinks 实例 WEB UI。然后，左键单击 WEB UI 右上角的三个点，然后选择“个人资料”。
...
现在导航到您的 GridLinks 实例的“设置”页面 -> “邮件服务器”选项卡，然后填写表单：
...
导航到您的 GridLinks 实例的“设置”页面 -> “邮件服务器”选项卡，然后填写表单：
...
- 在您的 GridLinks 实例中，转到“设置”页面 -> “邮件服务器”选项卡；
- 填写“发件人”字段；
- 选择 SMTP 提供商 - “**Google**”；
